...
export default function CommandBar(props) {
  ...
  const actions = [
    ...
    },
    {
      ...
      keywords: 'send-email',
      section: 'Geral',
      perform: () => window.open('mailto:lucassectitefe@gmail.com', '_blank'),
    ...
    },
    {
      ...
      section: 'Follow',
      perform: () => window.open('https://www.instagram.com/luccsouza_/', '_blank'),
    ...
    },
    {
      ...
      keywords: 'go-github',
      section: 'Follow',
      perform: () => window.open('https://github.com/souzalc', '_blank'),
    ...
    },
    {
      ...
      section: 'Follow',
      perform: () => window.open('https://www.linkedin.com/in/lucas-desenvolvedor/', '_blank'),
